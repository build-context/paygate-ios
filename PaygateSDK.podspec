...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/build-context/paygate'
  s.license          = { :type => 'MIT' }
  s.author           = { 'Paygate' => 'support@paygate.dev' }
  s.source           = { :git => 'https://github.com/build-context/paygate.git', :tag => "v#{s.version}" }
  s.source_files     = 'sdks/ios/Sources/PaygateSDK/**/*.swift'
  s.platform         = :ios, '15.0'
  s.swift_version    = '5.9'
end
